...
[TenantScoped]
public sealed record PropertyProcessingSuspendedIntegrationEvent : TenantIntegrationEvent
{
    public const string EventType = "property-processing-suspended";
    public const int EventVersion = 1;

    public PropertyProcessingSuspendedIntegrationEvent(
        Guid eventId,
        string tenantId,
