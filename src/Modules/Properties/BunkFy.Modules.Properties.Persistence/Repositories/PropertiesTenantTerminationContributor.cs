      ...
      ITenantTerminationExportContributor
{
    public TenantTerminationContributorDescriptor Descriptor { get; } = new(
        ...
        [
            ...
            new(
                ...
                PropertiesTenantTerminationMetadata.DestroyDependencyOwnerKeys)
        ],
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Failed(
                "properties.termination.export-request-invalid",
                startedAtUtc);
        }
        ...
        {
            return Failed(
                "properties.termination.export-transaction-conflict",
                startedAtUtc);
        }
        ...
        try
        {
            if (dbContext.Database.IsRelational())
            {
                ...
                await PropertiesTenantMutationLock.AcquireExclusiveAsync(
                    dbContext,
                    tenantId!,
            ...
            {
                return RetryRequired(
                    "properties.termination.export-revision-changed",
                    clock.UtcNow);
            }
            ...
            {
                return RetryRequired(
                    "properties.termination.export-deadline-expired",
                    completedAtUtc);
            }
            ...
            return new TenantTerminationContributionResult(
                ...
                "properties.termination.exported",
                recordCount,
    ...
    private async Task<long> GetOrCreateRevisionAsync(
        ...
        CancellationToken cancellationToken)
    {
        PropertiesTenantRevision? revision = await dbContext.TenantRevisions
            .SingleOrDefaultAsync(cancellationToken)
            .ConfigureAwait(false);
        if (revision is null)
        {
            revision = PropertiesTenantRevision.Create(tenantId);
