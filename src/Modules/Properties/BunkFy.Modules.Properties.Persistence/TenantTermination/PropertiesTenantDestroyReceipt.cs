...
internal sealed class PropertiesTenantDestroyReceipt : IScopedEntity
{
    private PropertiesTenantDestroyReceipt() { }
    ...
    public static PropertiesTenantDestroyReceipt? TryCreate(
        PropertiesTenantDestroyOperation operation,
        DateTimeOffset completedAtUtc)
    {
        ...
        if (operation is null ||
            ...
            operation.ProofVersion !=
                PropertiesTenantDestroyOperation.RemovalProofVersion ||
