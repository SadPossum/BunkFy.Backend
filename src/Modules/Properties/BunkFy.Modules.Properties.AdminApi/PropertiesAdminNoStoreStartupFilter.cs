...
internal sealed class PropertiesAdminNoStoreStartupFilter : IStartupFilter
{
    private static readonly PathString PropertiesPath = new("/api/admin/properties");
    ...
    public Action<IApplicationBuilder> Configure(Action<IApplicationBuilder> next)
    {
        ...
        return applicationBuilder =>
        {
            ...
            {
                if (context.Request.Path.StartsWithSegments(PropertiesPath))
                {
