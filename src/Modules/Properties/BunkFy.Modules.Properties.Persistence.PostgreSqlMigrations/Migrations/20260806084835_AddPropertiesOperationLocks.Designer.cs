...
namespace BunkFy.Modules.Properties.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260806084835_AddPropertiesOperationLocks")]
    partial class AddPropertiesOperationLocks
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tenant_destroy_operations", "properties", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_properties_tenant_destroy_operation_progress", "\"Stage\" BETWEEN 1 AND 10 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"ProofVersion\" = 1 AND \"ConcurrencyVersion\" >= 1");
