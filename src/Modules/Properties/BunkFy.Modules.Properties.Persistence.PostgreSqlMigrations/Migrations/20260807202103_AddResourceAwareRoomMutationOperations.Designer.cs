...
namespace BunkFy.Modules.Properties.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260807202103_AddResourceAwareRoomMutationOperations")]
    partial class AddResourceAwareRoomMutationOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("property_mutation_operations", "properties", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_properties_property_mutation_operations_kind", "\"Kind\" IN (1, 2, 3, 4, 5, 6)");

                            t.HasCheckConstraint("CK_properties_property_mutation_operations_resource", "(\"Kind\" IN (1, 2, 3, 4, 5) AND \"ResourceKind\" = 1 AND \"ResourceId\" = \"PropertyId\") OR (\"Kind\" = 6 AND \"ResourceKind\" = 2 AND \"ResourceId\" = \"ResultRoomId\")");
                            ...
                            t.HasCheckConstraint("CK_properties_property_mutation_operations_versions", "\"ExpectedVersion\" > 0 AND \"ResultVersion\" > 0 AND \"ResultResourceVersion\" >= \"ExpectedVersion\" AND \"ResultResourceVersion\" <= \"ExpectedVersion\" + 1");
                        });
                });
