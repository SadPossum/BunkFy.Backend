...
internal sealed class InventoryPropertyAccessScopeResolver(ITenantContext tenantContext) : IAccessHttpScopeResolver
{
    public const string ResolverName = "inventory-property";
