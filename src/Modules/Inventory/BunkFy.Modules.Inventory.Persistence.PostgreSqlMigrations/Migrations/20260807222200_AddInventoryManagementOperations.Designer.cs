...
namespace BunkFy.Modules.Inventory.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260807222200_AddInventoryManagementOperations")]
    partial class AddInventoryManagementOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("management_operations", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_inventory_management_operations_kind", "\"ResourceKind\" = 1 AND \"Kind\" = 1");

                            t.HasCheckConstraint("CK_inventory_management_operations_result", "\"ExpectedVersion\" > 0 AND \"ResultVersion\" >= \"ExpectedVersion\" AND \"ResultVersion\" - \"ExpectedVersion\" <= 1 AND \"ResultSalesMode\" IN (2, 3)");
                        });
                });
