...
namespace BunkFy.Modules.Inventory.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260809004643_AddInventoryManualBlockManagementOperations")]
    partial class AddInventoryManualBlockManagementOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("management_operations", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_inventory_management_operations_kind", "\"Kind\" BETWEEN 1 AND 5 AND ((\"Kind\" = 1 AND \"ResourceKind\" = 1) OR (\"Kind\" IN (2, 3) AND \"ResourceKind\" = 2 AND \"ResourceId\" = \"PropertyId\") OR (\"Kind\" = 4 AND \"ResourceKind\" = 3 AND \"ResultBlockId\" IS NOT NULL AND \"ResourceId\" = \"ResultBlockId\") OR (\"Kind\" = 5 AND \"ResourceKind\" = 4 AND \"ResultBlockGroupId\" IS NOT NULL AND \"ResourceId\" = \"ResultBlockGroupId\"))");
