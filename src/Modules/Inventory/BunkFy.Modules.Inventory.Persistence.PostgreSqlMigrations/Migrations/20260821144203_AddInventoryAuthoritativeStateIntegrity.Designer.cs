...
namespace BunkFy.Modules.Inventory.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260821144203_AddInventoryAuthoritativeStateIntegrity")]
    partial class AddInventoryAuthoritativeStateIntegrity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BunkFy.Modules.Inventory.Persistence.InventoryAllocationAmendmentDecision", b =>
                {
                    ...
                    b.ToTable("allocation_amendment_decisions", "inventory", t =>
                        {
                            t.HasCheckConstraint("CK_allocation_amendment_decisions_coordinates", "\"Id\" <> '00000000-0000-0000-0000-000000000000' AND \"AllocationId\" <> '00000000-0000-0000-0000-000000000000' AND \"ReservationId\" <> '00000000-0000-0000-0000-000000000000' AND \"PropertyId\" <> '00000000-0000-0000-0000-000000000000' AND length(trim(\"ScopeId\")) > 0");
