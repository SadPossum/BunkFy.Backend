...
public static class InventoryIntegrationSubjects
{
    ...
    public static string CreateAllocationAmendmentConfirmed(string subjectPrefix = IntegrationEventNaming.DefaultSubjectPrefix) =>
        IntegrationEventNaming.CreateSubject(subjectPrefix, InventoryModuleMetadata.Name, InventoryAllocationAmendmentConfirmedIntegrationEvent.EventType, InventoryAllocationAmendmentConfirmedIntegrationEvent.EventVersion);

    public static string CreateAllocationAmendmentRejected(string subjectPrefix = IntegrationEventNaming.DefaultSubjectPrefix) =>
        IntegrationEventNaming.CreateSubject(subjectPrefix, InventoryModuleMetadata.Name, InventoryAllocationAmendmentRejectedIntegrationEvent.EventType, InventoryAllocationAmendmentRejectedIntegrationEvent.EventVersion);
