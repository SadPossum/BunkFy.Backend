...
Ordering is a compiled example module. BunkFy wires it into `BunkFy.Host.Api` for now so future product modules can inspect cross-module contracts, projections, persistence, and public endpoint composition.
