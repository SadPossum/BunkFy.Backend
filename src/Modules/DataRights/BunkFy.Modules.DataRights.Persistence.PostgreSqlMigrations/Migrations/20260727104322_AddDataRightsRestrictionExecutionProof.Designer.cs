...
namespace BunkFy.Modules.DataRights.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260727104322_AddDataRightsRestrictionExecutionProof")]
    partial class AddDataRightsRestrictionExecutionProof
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("processing_ledger_entries", "data-rights", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_data_rights_processing_ledger_contract", "\"ContractVersion\" BETWEEN 1 AND 2");
                            ...
                            t.HasCheckConstraint("CK_data_rights_processing_ledger_policy", "\"PolicyEvidenceSchemaVersion\" = 1 AND length(trim(\"PolicyId\")) > 0 AND \"PolicyVersion\" >= 1 AND length(trim(\"RetentionPolicyId\")) > 0 AND \"RetentionPolicyVersion\" >= 1 AND char_length(\"PolicyContentSha256\") = 64");
