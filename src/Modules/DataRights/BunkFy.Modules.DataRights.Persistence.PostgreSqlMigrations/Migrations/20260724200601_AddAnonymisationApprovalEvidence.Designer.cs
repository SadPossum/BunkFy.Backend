...
namespace BunkFy.Modules.DataRights.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260724200601_AddAnonymisationApprovalEvidence")]
    partial class AddAnonymisationApprovalEvidence
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("cases", "data-rights", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_data_rights_cases_decision_state", "(\"Decision\" = 0 AND \"Status\" IN (1, 2, 3, 4, 11)) OR (\"Decision\" = 1 AND \"Status\" IN (5, 7, 8, 9, 10)) OR (\"Decision\" = 2 AND \"Status\" = 6)");
