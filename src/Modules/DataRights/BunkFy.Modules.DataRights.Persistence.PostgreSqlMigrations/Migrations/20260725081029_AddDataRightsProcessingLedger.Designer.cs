...
namespace BunkFy.Modules.DataRights.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260725081029_AddDataRightsProcessingLedger")]
    partial class AddDataRightsProcessingLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("processing_ledger_entries", "data-rights", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_data_rights_processing_ledger_contract", "\"ContractVersion\" = 1");
            ...
            modelBuilder.Entity("BunkFy.Modules.DataRights.Domain.Entities.DataRightsProcessingLedgerEntry", b =>
                {
                    b.HasOne("BunkFy.Modules.DataRights.Domain.Aggregates.DataRightsExecutionWorkItem", null)
                        .WithOne()
                        .HasForeignKey("BunkFy.Modules.DataRights.Domain.Entities.DataRightsProcessingLedgerEntry", "ScopeId", "WorkItemId")
                        .HasPrincipalKey("BunkFy.Modules.DataRights.Domain.Aggregates.DataRightsExecutionWorkItem", "ScopeId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
