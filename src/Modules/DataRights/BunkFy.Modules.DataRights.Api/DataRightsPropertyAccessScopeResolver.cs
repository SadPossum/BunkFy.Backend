...
internal sealed class DataRightsPropertyAccessScopeResolver(ITenantContext tenantContext)
    : IAccessHttpScopeResolver
{
    public const string ResolverName = "data-rights-property";
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!Guid.TryParse(
                httpContext.Request.RouteValues["propertyId"]?.ToString(),
                out Guid propertyId))
        {
            return ValueTask.FromResult(AccessScopeResolutionResult.Failure(
