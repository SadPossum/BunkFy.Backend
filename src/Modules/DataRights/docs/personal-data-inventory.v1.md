# data-rights Personal-Data Inventory v9
...
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | LedgerEntryId | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | OwnerReceiptId | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | OwnerReceiptSha256 | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | ReplayedAtUtc | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | ResultingRecordVersion | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreProof | TombstoneRevision | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | ContractVersion | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | LedgerEntryId | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | LedgerEntrySha256 | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | OriginallyCompletedAtUtc | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | OwnerKey | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | OwnerReceiptContractVersion | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | OwnerReceiptId | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | OwnerReceiptSha256 | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | RecordType | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | RoutingPropertyId | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | TenantId | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreRequest | TenantSequence | integration-command | transient-request |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Contracts | BunkFy.Modules.DataRights.Contracts.DataRightsAnonymisationRestoreResult | Proof | projection-export | transient-response |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | CheckpointMacSha256 | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | EntrySha256 | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | Id | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | IntegrityKeyVersion | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | LastReconciledAtUtc | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | ScopeId | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | ScopeSnapshotSha256 | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | StorageMacSha256 | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | TenantSequence | persistence | data-rights-processing-ledger |
| data-rights.guest-restore-proof | BunkFy.Modules.DataRights.Domain | BunkFy.Modules.DataRights.Domain.Entities.DataRightsRestoreCheckpoint | Version | persistence | data-rights-processing-ledger |
