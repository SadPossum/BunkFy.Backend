...
internal sealed class StaffTenantDestroyReceipt : IScopedEntity
{
    private StaffTenantDestroyReceipt() { }
    ...
    public static StaffTenantDestroyReceipt? TryCreate(
        StaffTenantDestroyOperation operation,
        DateTimeOffset completedAtUtc)
    {
        ...
        if (operation is null ||
            ...
            operation.ProofVersion !=
                StaffTenantDestroyOperation.RemovalProofVersion ||
