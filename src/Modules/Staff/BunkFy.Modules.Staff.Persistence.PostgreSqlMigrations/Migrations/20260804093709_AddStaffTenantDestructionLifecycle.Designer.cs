...
namespace BunkFy.Modules.Staff.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260804093709_AddStaffTenantDestructionLifecycle")]
    partial class AddStaffTenantDestructionLifecycle
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tenant_destroy_operations", "staff", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_staff_tenant_destroy_operation_progress", "\"Stage\" BETWEEN 1 AND 22 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"ProofVersion\" = 1 AND \"ConcurrencyVersion\" >= 1");
