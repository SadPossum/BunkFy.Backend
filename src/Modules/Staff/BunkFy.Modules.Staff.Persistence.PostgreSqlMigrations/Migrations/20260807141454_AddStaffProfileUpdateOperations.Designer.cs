...
namespace BunkFy.Modules.Staff.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260807141454_AddStaffProfileUpdateOperations")]
    partial class AddStaffProfileUpdateOperations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BunkFy.Modules.Staff.Persistence.StaffProfileUpdateOperation", b =>
                {
                    b.Property<string>("ScopeId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.ToTable("profile_update_operations", "staff", t =>
                        {
                            t.HasCheckConstraint("CK_staff_profile_update_operations_fingerprint", "char_length(\"RequestFingerprint\") = 64 AND \"RequestFingerprint\" ~ '^[0-9a-f]{64}$'");

                            t.HasCheckConstraint("CK_staff_profile_update_operations_status", "\"ResultStatus\" IN (1, 2)");

                            t.HasCheckConstraint("CK_staff_profile_update_operations_versions", "\"ExpectedVersion\" > 0 AND \"ResultVersion\" >= \"ExpectedVersion\" AND \"ResultVersion\" <= \"ExpectedVersion\" + 1");
                        });
                });
