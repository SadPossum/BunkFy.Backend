...
namespace BunkFy.Modules.Staff.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260807151742_GeneralizeStaffMemberMutationOperations")]
    partial class GeneralizeStaffMemberMutationOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("member_mutation_operations", "staff", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_staff_member_mutation_operations_kind", "\"Kind\" IN (1, 2)");

                            t.HasCheckConstraint("CK_staff_member_mutation_operations_status", "\"ResultStatus\" IN (1, 2)");
