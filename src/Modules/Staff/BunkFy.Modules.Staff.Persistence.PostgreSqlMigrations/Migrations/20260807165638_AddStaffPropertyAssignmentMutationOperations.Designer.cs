...
namespace BunkFy.Modules.Staff.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260807165638_AddStaffPropertyAssignmentMutationOperations")]
    partial class AddStaffPropertyAssignmentMutationOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("member_mutation_operations", "staff", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_staff_member_mutation_operations_kind", "\"Kind\" IN (1, 2, 3, 4, 5, 6, 7)");

                            t.HasCheckConstraint("CK_staff_member_mutation_operations_status", "\"ResultStatus\" IN (1, 2, 3)");

                            t.HasCheckConstraint("CK_staff_member_mutation_operations_versions", "\"ExpectedVersion\" > 0 AND \"ResultVersion\" >= \"ExpectedVersion\" AND \"ResultVersion\" <= \"ExpectedVersion\" + 1");
                        });
                });
