...
namespace BunkFy.Modules.Staff.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260730013320_AddStaffAnonymisationRestoreProof")]
    partial class AddStaffAnonymisationRestoreProof
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BunkFy.Modules.Staff.Domain.DataRights.StaffAnonymisationTombstone", b =>
                {
                    ...
                    b.ToTable("staff_anonymisation_tombstones", "staff", t =>
                        {
                            t.HasCheckConstraint("CK_staff_anonymisation_tombstones_authority", "\"Authority\" = 1");

                            t.HasCheckConstraint("CK_staff_anonymisation_tombstones_contract", "\"ContractVersion\" = 2");
