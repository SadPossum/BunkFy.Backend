...
internal sealed class RetentionTenantDestroyReceipt : IScopedEntity
{
    private RetentionTenantDestroyReceipt() { }
    ...
    public static RetentionTenantDestroyReceipt? TryCreate(
        RetentionTenantDestroyOperation operation,
        DateTimeOffset completedAtUtc)
    {
        ...
        if (operation is null ||
            ...
            operation.ProofVersion !=
                RetentionTenantDestroyOperation.RemovalProofVersion ||
