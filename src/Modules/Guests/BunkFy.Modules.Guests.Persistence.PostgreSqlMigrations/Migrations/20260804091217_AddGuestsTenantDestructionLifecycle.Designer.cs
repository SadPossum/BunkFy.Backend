...
namespace BunkFy.Modules.Guests.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260804091217_AddGuestsTenantDestructionLifecycle")]
    partial class AddGuestsTenantDestructionLifecycle
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tenant_destroy_operations", "guests", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_guests_tenant_destroy_operation_progress", "\"Stage\" BETWEEN 1 AND 20 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"ProofVersion\" = 1 AND \"ConcurrencyVersion\" >= 1");
