...
{
    /// <inheritdoc />
    public partial class AddGuestsTenantDestructionLifecycle : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_guests_tenant_destroy_operation_batch", "\"BatchSize\" BETWEEN 1 AND 500");
                    table.CheckConstraint("CK_guests_tenant_destroy_operation_progress", "\"Stage\" BETWEEN 1 AND 20 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"ProofVersion\" = 1 AND \"ConcurrencyVersion\" >= 1");
                    table.CheckConstraint("CK_guests_tenant_destroy_operation_revisions", "\"SelectedRevision\" >= 0 AND \"ResultingRevision\" = \"SelectedRevision\" + 1");
                    table.CheckConstraint("CK_guests_tenant_destroy_operation_times", "\"UpdatedAtUtc\" >= \"StartedAtUtc\"");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_guests_tenant_destroy_receipt_progress", "((\"RemovedRecordCount\" = 0 AND \"CompletedBatchCount\" = 0) OR (\"RemovedRecordCount\" > 0 AND \"CompletedBatchCount\" > 0)) AND \"BatchSize\" BETWEEN 1 AND 500 AND \"RemovalProofVersion\" = 1");
                    table.CheckConstraint("CK_guests_tenant_destroy_receipt_revisions", "\"SelectedRevision\" >= 0 AND \"ResultingRevision\" = \"SelectedRevision\" + 1");
                    table.CheckConstraint("CK_guests_tenant_destroy_receipt_times", "\"CompletedAtUtc\" >= \"StartedAtUtc\"");
                });

            migrationBuilder.AddCheckConstraint(
                name: "CK_guests_tenant_revision_lifecycle",
                schema: "guests",
                table: "tenant_revisions",
            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    destroy_operation_id := current_setting(
                        'bunkfy.guests_tenant_destroy_operation_id',
                        true);
                    IF TG_OP = 'DELETE' AND destroy_operation_id IS NOT NULL AND
                       EXISTS (
                           SELECT 1
                           FROM guests.tenant_destroy_operations operation
                           INNER JOIN guests.tenant_revisions state
                ...
                CREATE TRIGGER guests_tenant_destroy_receipts_append_only
                BEFORE UPDATE OR DELETE
                ON guests.tenant_destroy_receipts
                FOR EACH ROW
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                DROP TRIGGER IF EXISTS
                    guests_tenant_destroy_receipts_append_only
                ON guests.tenant_destroy_receipts;
