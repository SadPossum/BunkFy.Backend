...
public sealed class GuestRetentionExecution : ScopedAggregateRoot<Guid>
{
    ...
    private GuestRetentionExecution(Guid id, string scopeId)
        : base(id, scopeId)
    {
    }
    ...
    public GuestRetentionExecutionState State { get; private set; }
    ...
    public static Result<GuestRetentionExecution> Start(
        Guid id,
        string tenantId,
        string dataClassKey,
        ...
        DateTimeOffset deadlineUtc)
    {
        ...
        {
            return Result.Failure<GuestRetentionExecution>(
                GuestsDomainErrors.RetentionExecutionCoordinateInvalid);
        }

        return Result.Success(new GuestRetentionExecution(id, scopeId)
        {
            DataClassKey = normalized,
            ExecutionPolicyVersion = executionPolicyVersion,
            Attempt = attempt,
            StartingProjectionOrdinal = startingProjectionOrdinal,
            State = GuestRetentionExecutionState.Running,
        ...
        DateTimeOffset? holdReviewDueAtUtc)
    {
        ...
        bool blocked = state == GuestRetentionExecutionState.Blocked;
        if (state is not (
        ...
        {
            return Result.Failure(
                GuestsDomainErrors.RetentionExecutionResultInvalid);
        }
