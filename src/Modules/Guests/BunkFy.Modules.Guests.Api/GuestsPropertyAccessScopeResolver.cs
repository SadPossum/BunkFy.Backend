...
internal sealed class GuestsPropertyAccessScopeResolver(ITenantContext tenantContext) : IAccessHttpScopeResolver
{
    public const string ResolverName = "guests-property";
