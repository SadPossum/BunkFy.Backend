...
[TenantScoped]
public sealed record ReservationGuestStayChangedIntegrationEvent : TenantIntegrationEvent
{
    public const string EventType = "reservation-guest-stay-changed";
    public const int EventVersion = 1;

    public ReservationGuestStayChangedIntegrationEvent(
        Guid eventId,
        string tenantId,
    ...
    public bool IsCurrentParticipant { get; }
