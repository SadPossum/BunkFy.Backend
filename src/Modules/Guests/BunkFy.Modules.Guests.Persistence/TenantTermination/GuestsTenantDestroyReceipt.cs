...
internal sealed class GuestsTenantDestroyReceipt : IScopedEntity
{
    private GuestsTenantDestroyReceipt() { }
    ...
    public static GuestsTenantDestroyReceipt? TryCreate(
        GuestsTenantDestroyOperation operation,
        DateTimeOffset completedAtUtc)
    {
        ...
        if (operation is null ||
            ...
            operation.ProofVersion !=
                GuestsTenantDestroyOperation.RemovalProofVersion ||
