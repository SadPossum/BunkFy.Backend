namespace BunkFy.Modules.Guests.Persistence.TenantTermination;

using Gma.Framework.Domain;

internal sealed class GuestsTenantDestroyOperation : IScopedEntity
{
    ...
    public static readonly string InitialRemovalProofSha256 =
        GuestsTenantLifecycleHashes.Sha256(
            "bunkfy-guests-tenant-destroy-proof/v1|empty");

    private GuestsTenantDestroyOperation() { }
        ...
        DateTimeOffset startedAtUtc)
    {
        ...
        this.Stage = GuestsTenantDestroyStage.OutboxMessages;
    ...
    public GuestsTenantDestroyStage Stage { get; private set; }
    ...
    public bool IsComplete => this.Stage == GuestsTenantDestroyStage.Completed;

    public static GuestsTenantDestroyOperation? TryCreate(
        Guid operationId,
        string scopeId,
        string requestSha256,
        long selectedRevision,
        ...
        DateTimeOffset startedAtUtc)
    {
        if (operationId == Guid.Empty ||
            ...
            !GuestsTenantLifecycleHashes.IsSha256(requestSha256) ||
        ...
        DateTimeOffset recordedAtUtc)
    {
        if (this.IsComplete ||
            ...
            !GuestsTenantLifecycleHashes.IsSha256(
        ...
        this.RemovalProofSha256 = GuestsTenantLifecycleHashes.Sha256(
            "bunkfy-guests-tenant-destroy-proof/v1|" +
    ...
    private static GuestsTenantDestroyStage Next(
        GuestsTenantDestroyStage stage)
    {
...
internal enum GuestsTenantDestroyStage
{
    Unknown = 0,
    OutboxMessages = 1,
    InboxMessages = 2,
    ...
    DataHolds = 10,
    ProcessingRestrictions = 11,
    RetentionExecutions = 12,
    StayHistory = 13,
    GuestProfiles = 14,
    ProcessingRestrictionProjections = 15,
    PropertyProjections = 16,
