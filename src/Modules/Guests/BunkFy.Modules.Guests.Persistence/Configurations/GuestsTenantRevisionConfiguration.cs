...
internal sealed class GuestsTenantRevisionConfiguration
    : IEntityTypeConfiguration<GuestsTenantRevision>
{
    public void Configure(EntityTypeBuilder<GuestsTenantRevision> builder)
    {
        builder.ToTable(
            "tenant_revisions",
