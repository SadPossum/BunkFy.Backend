...
internal sealed class GuestsTenantDestroyReceiptConfiguration
    : IEntityTypeConfiguration<GuestsTenantDestroyReceipt>
{
    public void Configure(
        EntityTypeBuilder<GuestsTenantDestroyReceipt> builder)
    {
        builder.ToTable("tenant_destroy_receipts", table =>
        {
            table.HasCheckConstraint(
                "CK_guests_tenant_destroy_receipt_revisions",
            ...
            table.HasCheckConstraint(
                ...
                $"{GuestsTenantDestroyOperation.MaximumBatchSize} AND " +
                "\"RemovalProofVersion\" = 1");
            table.HasCheckConstraint(
                "CK_guests_tenant_destroy_receipt_times",
