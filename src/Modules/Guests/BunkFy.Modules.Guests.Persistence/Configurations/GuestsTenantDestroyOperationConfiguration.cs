...
internal sealed class GuestsTenantDestroyOperationConfiguration
    : IEntityTypeConfiguration<GuestsTenantDestroyOperation>
{
    public void Configure(
        EntityTypeBuilder<GuestsTenantDestroyOperation> builder)
    {
        builder.ToTable("tenant_destroy_operations", table =>
        {
            table.HasCheckConstraint(
                "CK_guests_tenant_destroy_operation_revisions",
            ...
            table.HasCheckConstraint(
                "CK_guests_tenant_destroy_operation_times",
