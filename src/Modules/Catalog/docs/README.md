...
Catalog is a compiled example module. BunkFy wires it into `BunkFy.Host.Api`, `BunkFy.Host.AdminCli`, and `BunkFy.Host.AdminApi` for now so future product modules have a live reference implementation to follow.
