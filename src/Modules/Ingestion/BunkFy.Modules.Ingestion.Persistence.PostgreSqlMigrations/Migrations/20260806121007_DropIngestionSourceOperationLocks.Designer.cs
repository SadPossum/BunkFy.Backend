...
namespace BunkFy.Modules.Ingestion.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260806121007_DropIngestionSourceOperationLocks")]
    partial class DropIngestionSourceOperationLocks
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tenant_destroy_operations", "ingestion", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ingestion_tenant_destroy_operation_progress", "\"Stage\" BETWEEN 1 AND 22 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"RemovedRawPayloadCount\" >= 0 AND \"CompletedRawPayloadBatchCount\" >= 0 AND \"ProofVersion\" = 1 AND \"RawPayloadRemovalProofVersion\" = 1 AND \"ConcurrencyVersion\" >= 1");
