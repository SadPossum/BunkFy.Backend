...
namespace BunkFy.Modules.Ingestion.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260809034638_AddIngestionConnectionManagementOperations")]
    partial class AddIngestionConnectionManagementOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("connection_management_operations", "ingestion", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ingestion_connection_management_operations_create", "\"Kind\" = 1 AND \"ExpectedVersion\" = 0 AND \"ResultVersion\" = 1 AND \"Id\" = \"ConnectionId\"");
