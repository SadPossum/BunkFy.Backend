...
namespace BunkFy.Modules.Ingestion.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260809054601_AddIngestionConnectionControlOperations")]
    partial class AddIngestionConnectionControlOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("connection_management_operations", "ingestion", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ingestion_connection_management_operations_outcome", "(\"Kind\" = 1 AND \"ExpectedVersion\" = 0 AND \"ResultVersion\" = 1 AND \"Id\" = \"ConnectionId\") OR (\"Kind\" IN (2, 5, 6, 7) AND \"ExpectedVersion\" > 0 AND \"ResultVersion\" >= \"ExpectedVersion\" AND \"ResultVersion\" <= \"ExpectedVersion\" + 1) OR (\"Kind\" IN (3, 4) AND \"ExpectedVersion\" > 0 AND \"ResultVersion\" = \"ExpectedVersion\" + 1)");
                        });
                });
