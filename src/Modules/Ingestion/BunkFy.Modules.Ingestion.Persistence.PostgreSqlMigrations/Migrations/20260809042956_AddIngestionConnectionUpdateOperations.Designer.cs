...
namespace BunkFy.Modules.Ingestion.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    [Migration("20260809042956_AddIngestionConnectionUpdateOperations")]
    partial class AddIngestionConnectionUpdateOperations
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("connection_management_operations", "ingestion", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ingestion_connection_management_operations_outcome", "(\"Kind\" = 1 AND \"ExpectedVersion\" = 0 AND \"ResultVersion\" = 1 AND \"Id\" = \"ConnectionId\") OR (\"Kind\" = 2 AND \"ExpectedVersion\" > 0 AND \"ResultVersion\" >= \"ExpectedVersion\" AND \"ResultVersion\" <= \"ExpectedVersion\" + 1)");
                        });
                });
