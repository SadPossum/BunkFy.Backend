...
{
    public static IngestionAnonymisationRoutingPolicyEvidence
        FromApproval(DataRightsApprovalEvidence evidence)
    {
    ...
    public static bool MatchesApproval(
        IngestionAnonymisationRoutingPolicyEvidence requested,
