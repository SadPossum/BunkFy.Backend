...
internal sealed class IngestionPropertyAccessScopeResolver(ITenantContext tenantContext) : IAccessHttpScopeResolver
{
    public const string ResolverName = "ingestion-property";
