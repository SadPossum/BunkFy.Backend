...
internal sealed class IngestionSourceOperationLockConfiguration
    : IEntityTypeConfiguration<IngestionSourceOperationLock>
{
    public void Configure(
        EntityTypeBuilder<IngestionSourceOperationLock> builder)
    {
        builder.ToTable("source_operation_locks", table =>
        {
            table.HasCheckConstraint(
                "CK_ingestion_source_operation_locks_revision",
                "\"Revision\" >= 1");
        });
