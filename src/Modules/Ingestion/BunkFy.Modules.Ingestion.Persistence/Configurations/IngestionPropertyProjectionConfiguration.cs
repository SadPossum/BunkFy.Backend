    ...
    : IEntityTypeConfiguration<IngestionPropertyProjection>
{
    public void Configure(EntityTypeBuilder<IngestionPropertyProjection> builder)
    {
        builder.ToTable("property_projection", table =>
        {
            ...
            table.HasCheckConstraint(
                "CK_property_projection_processing_status",
                "\"ProcessingStatus\" BETWEEN 1 AND 3");
            table.HasCheckConstraint(
                "CK_property_projection_governance_policy",
        ...
        builder.Property(property => property.TopologySourceVersion).IsRequired();
        builder.Property(property => property.PolicySourceVersion).IsRequired();
        ...
        builder.OwnsOne(property => property.GovernancePolicy, policy =>
        {
            ...
            policy.OwnsMany(value => value.Acknowledgements, acknowledgements =>
            {
                ...
                acknowledgements.HasKey(
                    "PropertyId",
                    nameof(IngestionPropertyPolicyAcknowledgement.AcknowledgementId),
                    nameof(IngestionPropertyPolicyAcknowledgement.AcknowledgementVersion));
