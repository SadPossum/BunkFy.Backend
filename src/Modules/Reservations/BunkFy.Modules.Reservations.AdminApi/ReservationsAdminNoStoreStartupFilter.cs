...
internal sealed class ReservationsAdminNoStoreStartupFilter : IStartupFilter
{
    private static readonly PathString ReservationsPath = new("/api/admin/reservations");
