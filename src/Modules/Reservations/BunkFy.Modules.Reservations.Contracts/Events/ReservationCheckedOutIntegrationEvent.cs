...
[TenantScoped]
public sealed record ReservationCheckedOutIntegrationEvent : TenantIntegrationEvent
{
    public const string EventType = "reservation-checked-out";
    public const int EventVersion = 1;

    public ReservationCheckedOutIntegrationEvent(
        Guid eventId,
        string tenantId,
