...
[TenantScoped]
public sealed record ReservationNoShowIntegrationEvent : TenantIntegrationEvent
{
    public const string EventType = "reservation-no-show";
    public const int EventVersion = 1;

    public ReservationNoShowIntegrationEvent(
        Guid eventId,
        string tenantId,
