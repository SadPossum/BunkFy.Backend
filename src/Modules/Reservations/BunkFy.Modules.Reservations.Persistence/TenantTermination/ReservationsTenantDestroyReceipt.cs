...
internal sealed class ReservationsTenantDestroyReceipt : IScopedEntity
{
    private ReservationsTenantDestroyReceipt() { }
    ...
    public static ReservationsTenantDestroyReceipt? TryCreate(
        ReservationsTenantDestroyOperation operation,
        DateTimeOffset completedAtUtc)
    {
        ...
        if (operation is null ||
            ...
            operation.ProofVersion !=
                ReservationsTenantDestroyOperation.RemovalProofVersion ||
