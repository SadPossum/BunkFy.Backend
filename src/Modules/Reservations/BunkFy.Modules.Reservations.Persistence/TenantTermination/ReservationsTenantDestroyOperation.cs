...
internal enum ReservationsTenantDestroyStage
{
    ...
    DetailsHistory = 12,
    DataHolds = 13,
    ProcessingRestrictions = 14,
    RetentionExecutions = 15,
    ReservationGuests = 16,
    RequestedInventoryUnits = 17,
    Reservations = 18,
    InventoryAllocationUnits = 19,
    InventoryAllocations = 20,
    InventoryBlocks = 21,
    InventoryUnits = 22,
    GuestProcessingRestrictionProjections = 23,
    GuestProfileProjections = 24,
    ProcessingRestrictionProjections = 25,
    PropertyProjections = 26,
    ProjectionRebuildCheckpoints = 27,
    RetentionSweepCheckpoints = 28,
    OperationLocks = 29,
    Completed = 30
}
