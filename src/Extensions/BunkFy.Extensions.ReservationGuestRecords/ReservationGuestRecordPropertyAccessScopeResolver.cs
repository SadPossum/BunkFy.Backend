...
internal sealed class ReservationGuestRecordPropertyAccessScopeResolver(
    ITenantContext tenantContext) : IAccessHttpScopeResolver
{
    public const string ResolverName = "reservation-guest-record-property";
